...
const MyResult = ({apiBase="https://quiz-app-backend-75qo.onrender.com"}) => {
      ...
      try {
        const q =
          tech && tech.toLowerCase() !== "all"
            ...
            : "";
            console.log("Authorization header being sent:", getAuthHeader());
        ...
        <div className={resultStyles.loadingContainer}>
          <div className={resultStyles.loadingSpinner}/>
            ...
            {Object.entries(grouped).map(([track,items])=>(
              <section key={track} className={resultStyles.trackTitle}>
                <h2 className={resultStyles.trackTitle}>{track}Track</h2>
              
                <div className={resultStyles.resultsGrid}>
                  {items.map((r)=>(
                    <StripCard key={makeKey(r)} item={r}></StripCard>
                  ))}
      ...
      <div className={resultStyles.cardContent}>
        ...
        <div className={resultStyles.cardStats}>
          <div className={resultStyles.statItem}>Correct:
            <span className={resultStyles.statNumber}
            > {item.correct}</span>
          </div>
