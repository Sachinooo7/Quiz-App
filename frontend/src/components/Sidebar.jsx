...
import { Award, BookOpen, ChevronDown, Code, Coffee, Cpu, Database, Globe, Layout, Sparkles, Star, Target, Terminal, Trophy, User, X, Zap } from 'lucide-react';
...
const Sidebar = () => {
  ...
  <div className={sidebarStyles.mainContainer}>
    <aside 
    ref={asideRef} 
className={`${sidebarStyles.sidebar} ${isSidebarOpen ? "translate-x-0" : "md:translate-x-0 -translate-x-full"}`}
        ...
        {technologies.map((tech)=>(
          ...
          data-tech={tech.id}>
            ...
            className={`${sidebarStyles.techButton} ${
              ...
              {
                selectedTech===tech.id ?(
                  <ChevronDown size={18} className="text-current"></ChevronDown>
                ):(
                  <ChevronDown size={18} className="text-gray-400"></ChevronDown>
                )
              }
            </button>
